...
$resultset1 = mysqli_query($connection1, "select teachName from teacher");
...
<!--                                            </select>-->
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Stds">No of students <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="Stds" class="form-control col-md-7 col-xs-12" data-validate-length-range="20" data-validate-words="4" name="Stds"  required="required" type="text">
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="disc">Discription
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea id="disc" required="required" name="disc" class="form-control col-md-7 col-xs-12"></textarea>
                                        </div>
                                    </div>

...
$resultset = mysqli_query($connection, "select * from class");
?>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form  id="frmAddAdmin" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal form-label-left" novalidate>
                            ...
                            <div>
                                <button id="btndeletecls" class="btn btn-danger" type="submit">Delete</button>
                                <a href="addClass.php"><button id="btnNewCls" class="btn btn-primary" type="submit">New Class</button></a>
                            </div>
                            <br>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    while ($rowdata = mysqli_fetch_row($resultset)) {
                                        echo "<tr>
                                                  <td><input type=\"checkbox\" value=$rowdata[0] name=\"clsCode[]\"></td>
                                                  <td>$rowdata[0]</td>
                                                  <td>$rowdata[1]</td>
                                                  <td>$rowdata[2]</td>

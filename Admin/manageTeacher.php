...
if (!$connection){
    ...
    $resultset = mysqli_query($connection, "select * from teacher");
    ?>
    ...
    <div>
        <button id="btndeleteTeach" class="btn btn-danger" type="submit">Delete</button>
        <a href="addTeacher.php"> <button id="btnNewTeach" href="Admin/addTeacher.php" class="btn btn-primary" type="button">New Teacher</button></a>
    </div>
    <br>
    <br>
    ...
    <tr class="headings">
        ...
        while ($rowdata = mysqli_fetch_row($resultset)) {
            echo "<tr>
                  <td><input type=\"checkbox\" value=$rowdata[0] name=\"teachCode[]\"></td>
                  <td>$rowdata[0]</td>
                  <td>$rowdata[1]</td>
                  <td>$rowdata[2]</td>

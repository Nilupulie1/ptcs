                                    ...
                                    <div class="x_content">
                                        ...
                                        <form class="form-horizontal form-label-left" novalidate>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="teachName" class="form-control col-md-7 col-xs-12" data-validate-length-range="20" data-validate-words="4" name="teachName" placeholder="Full Name (eg : John Doe)" required="required" type="text">
                                                </div>
                                            </div>

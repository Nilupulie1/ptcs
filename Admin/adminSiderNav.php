                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="addClass.php"><i class="fa fa-edit"></i> Manage Class <span class="fa fa-chevron-down"></span></a>

                            </li>
                            <li><a href="addTeacher.php"><i class="fa fa-table"></i> Manage Techer<span class="fa fa-chevron-down"></span></a>
                            <li><a href="addParents.php"><i class="fa fa-table"></i> Manage Student<span class="fa fa-chevron-down"></span></a>

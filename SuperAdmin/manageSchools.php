...
if (!$connection){
    ...
    $resultset = mysqli_query($connection, "select * from school");
    ?>
    ...
    <div>
        ...
        <a href="AddSchool.php"><button id="btnNewSchool" class="btn btn-primary" type="button">New School</button></a>
    </div>
    <br>
    <br>
    ...
    while ($rowdata = mysqli_fetch_row($resultset)) {
        echo "<tr>
                  <td><input type=\"checkbox\" value=$rowdata[0] name=\"sclCode[]\"></td>
                  <td>$rowdata[0]</td>
                  <td>$rowdata[1]</td>
                  <td>$rowdata[2]</td>

...
if (!$connection){
    ...
    <div>
        <button id="btnDeleteAdmin" class="btn btn-danger" type="submit">Delete Admin</button>
<!--        <a href="AddAdmin.php"><button id="btnNewSchool" class="btn btn-primary" type="button">New Admin</button></a>-->
        <a href="AddAdmin.php"><button id="btnNewAdmin" class="btn btn-primary" type="button">New Admin</button></a>
    </div>
    <br>
    <br>
...
<tbody>
    ...
    while ($rowdata = mysqli_fetch_row($resultset)) {
        echo "<tr>
                  <td><input type=\"checkbox\" value=$rowdata[0] name=\"adminCode[]\"></td>
                  <td>$rowdata[0]</td>
                  <td>$rowdata[1]</td>
                  <td>$rowdata[2]</td>

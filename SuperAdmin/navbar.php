                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="AddSchool.php?title=Manage School"><i class="fa fa-edit"></i> Manage Schools <span class="fa fa-chevron-down"></span></a>

                            </li>
                            <li><a href="AddAdmin.php?title=Manage Adsmin"><i class="fa fa-table"></i> Manage Admins<span class="fa fa-chevron-down"></span></a>

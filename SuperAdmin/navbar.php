                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="superAdminDash.php"><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a> </li>
                            <li><a href="AddSchool.php"><i class="fa fa-edit"></i> Manage Schools <span class="fa fa-chevron-down"></span></a>

                            </li>
                            <li><a href="AddAdmin.php"><i class="fa fa-table"></i> Manage Admins<span class="fa fa-chevron-down"></span></a>
